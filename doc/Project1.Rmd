...
---
When we were in school, we were happy because when we got good grades. Then we went into the workforce, we were happy because of getting promoted. Next, we went into middle ages, we were happy because of children. When our children had grown up, what will make happy? For people in different life stages, some sources of their happiness are changing but some are not. Let's look at what will change and what will not through this data analysis. 

```{r pressure, echo=FALSE, out.width = '70%'}
knitr::include_graphics("happiness.png")
```

At the begining of the study, I will use topic modeling to divide happy moments in life into three categories. Next, I will investigate what moments in lives will make people happy when they are in different life stages. Finally, I will show my findings about the wording behavior of different people. 
